...
{\bf \large Descripción:}\newline
  ...
  El curso de R Nivel Básico tiene como objetivo principal proporcionar al estudiante los elementos básicos para iniciarse con el trabajo en el lenguaje de programación R.\newline
...
\begin{enumerate}
  ...
  \item {\Large Funciones}
    \begin{enumerate}
    \item[5.1] Funciones internas
    \item[5.2] Creación de funciones
    \item[5.3] Edición de funciones
    \item[5.4] Almacenamiento de funciones
  \end{enumerate}
\end{enumerate}

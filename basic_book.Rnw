...
Para introducirnos en el \emph{mundo de R} debemos tener claro la doble naturaleza de \emph{programa o entorno} y \emph{lenguaje de programación}, pues R integra un conjunto de herramientas y un lenguaje de comandos para la manipulación de datos, la realización de cálculos y análisis estadísticos, así como su representación gráfica en alta calidad.\newline
...
\begin{figure}[H]
\centering
\includegraphics[scale=.6]{figuras/logo_r.eps}
...
\begin{figure}[H]
\centering
\includegraphics[height=4.5cm, width=3.5cm]{figuras/Ross.eps}
\includegraphics[height=4.5cm, width=3.5cm]{figuras/Robert.eps}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.4]{figuras/install1.eps}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=4.5cm,height=1.5cm]{figuras/install2.eps}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=8cm,height=3.5cm]{figuras/install3.eps}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=9cm,height=4cm]{figuras/install4.eps}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=7.5cm,height=2.5cm]{figuras/install5.eps}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.35]{figuras/console.eps}
...
\begin{itemize}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/archivo.eps}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/editar.eps}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/visualizar.eps}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/misc.eps}
  ...
  \end{figure}
    ...
    \end{itemize}
  \item {\bf \Large Paquetes:} Dedicado al manejo de las librerías que posee el programa R.
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/paquetes.eps}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/ventanas.eps}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[scale=.35]{figuras/ayuda.eps}
...
La selección de dos o más variables se realizada anteponiendo \code{\texttt{.()}} o su equivalente \code{\texttt{list()}}
...
<<fig.height=3.5, fig.width=6.5, fig.align='center'>>=
base[,{print(B1)

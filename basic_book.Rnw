...
\includegraphics[scale=2.5]{logo_only.pdf}
\vspace{2cm}\\
...
En la actualidad\footnote{Información obtenida al 21 de Diciembre 2014.} existen 6129 paquetes válidos en el repositorio CRAN, que se encuentran ordenados por fecha de publicación o alfabéticamente agrupadas en diversas líneas de investigación.

...
Para introducirnos en el mundo de R debemos tener claro dos conceptos: lenguaje de programación y entorno estadístico, pues R integra un conjunto de herramientas y un lenguaje de comandos para la manipulación de datos, la realización de cálculos y análisis de los mismos así como su representación gráfica en alta calidad. El programa R es un software libre distribuido bajo GNU General Public License muy utilizado por la comunidad científica debido a su doble naturaleza, como lenguaje y como entorno.
\begin{figure}[H]
\centering
...
El desarrollo de R inició en el año de 1991 con los profesores del Departamento de Estadística {\bf Ross Ihaka} y {\bf Robert Gentleman} de la Universidad de Aukland, su primer anuncio al público se dio en el año de 1993 (versión alfa) mientras que dos años más tarde Martin Machler convence a sus amigos Ross $\&$ Robert que distribuyan R bajo licencia GNU General Public License, por lo cual en Junio de 1995 aparece la primera versión libre (open source), para Febrero del año 2000 aparece la versión 1.0.0. Desde entonces el programa se distribuye gratuitamente a través del repositorio \emph{Comprehensive R Archive Network} (CRAN) en \url{http://www.r-project.org} su mantenimiento se encuentra a cargo del grupo {\bf R Core Team}\footnote{El R Core Team es el grupo de desarrolladores talentosos y experimentados con permisos para manipular el código fuente de R, en la actualidad lo conforman alrededor de 20 personas que se encuentran en 11 diferentes cuidades.} desde el año 1997 asistido por una gran cantidad de colaboradores internacionales.
...
\begin{figure}[H]
\centering
\includegraphics[scale=.45]{logo_rro.eps}
...
%R AnalyticFlow es un software que permite el análisis de datos de estado-of-the-art dibujando diagramas de flujo de análisis. Usted puede compartir con eficacia los procesos de análisis de datos en trabajos colaborativos. El software está disponible de forma gratuita para cualquier propósito.

%Absolutamente, he estado usando R Analítica Flow (RAF, bastante un buen nombre, ¿no?). Lo más hermoso de la Royal Air Force, hasta el momento, es que importa archivo .R y generar una estructura lineal. A continuación, los usuarios pueden manipular la estructura lineal de cualquier forma (órdenes de código en ejecución) que les gusta, y también permite a los usuarios exportar la estructura manipulado como códigos .R.

%Visual.
%– Easier to think,share and remember. – Once created,anyone can use it.
%Flexible.
%– Data analysis is not always straightway. – It can represent branching processes.

%Availability
%– Freely available!
%– Open sourced under the BSD license. – Download from:
%http://www.ef-prime.com/

%About us: Ef-prime, Inc.
%– A data analysis company • Location: Tokyo, Japan
%– Services:
%Data analysis consulting • Software development
%Training
%– Ryota Suzuki
%An author of package pvclust 
%Running the company with friends
...
La siguiente tabla muestra los 6 tipos de vectores, sus respectivos modos y la forma de almacenamiento.
\begin{table}{H}
\centering
...
\paragraph{Creación de vectores}
~\\

Ahora nos enfocaremos en mostrar al lector varias maneras de crear vectores de acuerdo a sus necesidades. Iniciamos generando vectores con ciertos elementos ya conocidos:
...
Los valores perdidos dentro de un vector son especificados con {\bf NA}, el cual es un vector lógico de longitud 1.




\subsubsection{Agregando y eliminando elementos}

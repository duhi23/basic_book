...
En el caso que se desee eliminar ciertas variables u objetos innecesarios del área de trabajo usamos la funcion \code{\texttt{rm()}}. 
<<>>=
# Mostramos los objetos actuales
ls()
# Eliminamos las variables: var, var1, var2, var3
rm(var, var1, var2, var3)
# Revisamos los objetos restantes
ls()
@

Para eliminar todo los objetos del área de trabajo usaremos el comando:
<<>>=
# Elimina todo los objetos
rm(list=ls())
# Verificamos
ls()
@

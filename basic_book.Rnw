...
Tiempo más tarde, Ross Ihaka $\&$ Robert Gentleman llegan a ser colegas en la Universidad de Auckland\footnote{Universidad pública situada en Auckland. Fue fundada en 1883 como parte de la Universidad de Nueva Zelanda.}, y ambos muestran interés en temas de Estadística Computacional, como profesores del Departamento de Estadística ven la necesidad de mejorar un ambiente del laboratorio de computación e inician su trabajo con la visión de crear un lenguaje similar al S pero con más funcionalidades, mismas que ya fueron identificadas por Ross previamente en su intento de incluir ambientes léxicos.\newline 

El desarrollo de R como tal inició en el año de 1991, el progreso fue bastante bueno por lo que en Agosto de 1993 decidieron colocar algunas copias binarias de R en Statlib, y a la vez anunciar al público por medio de la lista de noticias de S (S news mailing list). De manera sorpresiva un gran número de personas ofrecieron retroalimentación de la versión alfa que habían liberado, entre ellos el más persistente fue Martin Machler que los animó a liberar el código fuente de manera que R se distribuya bajo licencia GNU General Public License, por lo cual en Junio de 1995 aparece la primera versión libre (open source), el interés por R creció rapidamente al punto que para Marzo de 1996 fue necesario crear la propia lista de noticias y un año más tarde se tuvo que reemplazar por listas específicas: R-announce, R-help $\&$ R-devel, esto debido a la gran cantidad de consultas que realizaban los usuarios en varios temas. 

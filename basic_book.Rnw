...
%Entre las ventajas que posee la interfaz se encuentra la creación de flujos a través de los cuales se pueden ejecutar diferentes rutinas. Al momento de insertar nodos dentro de la interfaz podemos insertar código R, lo cual hace que dicho nodo  

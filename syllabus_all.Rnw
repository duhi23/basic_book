...
\begin{enumerate}
   ...
   \begin{enumerate}
      ...
      \item[3.4]{Multiples gráficos de distribución.} Se genera los gráficos enumerados anteriormente pero
      esta vez para los distintos suconjuntos en los que se puede dividir la data original.
   \end{enumerate}
...
\begin{figure}[H]
\begin{center}
     \includegraphics[width=0.7\textwidth]{gui_sim_var.eps}
